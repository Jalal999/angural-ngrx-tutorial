...
export class ReadComponent implements OnInit {
  ...
  //We're accessing the store from ngrx within the constructor, and 
  //then selecting tutorial which is defined as a the property from app.module.ts in StoreModule.forRoot({}). 
